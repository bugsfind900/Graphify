...
inner join tbl_society_master sm on sm.sc_sm_id= ag.sc_sm_id and ag.is_manual='1'
 where  ag.created_on >= '2026-01-01 10:00:00' 
 and  ag.created_on <= '2026-02-03 13:50:00' and ag.status = 'IN-PROGRESS';




select sc_sm_id,count(is_approved),created_on from erp.acc_bills 
where is_approved='0' and created_on >= '2026-02-01 00:00:00' 
